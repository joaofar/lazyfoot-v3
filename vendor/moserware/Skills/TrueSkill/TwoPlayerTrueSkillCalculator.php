...
require "../../Skills/SkillCalculator.php";
require "../../Skills/TeamsRange.php";
require "../../Skills/PlayersRange.php";
require "../../Skills/RankSorter.php";
require "../../Skills/PairwiseComparison.php";
require "../../Skills/TrueSkill/DrawMargin.php";
require "../../Skills/TrueSkill/TruncatedGaussianCorrectionFunctions.php";
